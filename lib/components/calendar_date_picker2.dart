...
const double _subHeaderHeight = 44.0;
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontFamily: CupertinoIcons
                                            .chevron_forward.fontFamily,
                                        package: CupertinoIcons
                                            .chevron_forward.fontPackage,
                                      ),
                                    ),
                              ),
                      ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  icon: widget.config.lastMonthIcon ??
                      const Icon(CupertinoIcons
                                          .chevron_back, color: Colors.black,),
                  color: controlColor,
                ...
                IconButton(
                  icon: widget.config.nextMonthIcon ??
                      const Icon(CupertinoIcons
                                          .chevron_forward, color: Colors.black,),
                  color: controlColor,
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color selectedDayColor = Colors.red;
